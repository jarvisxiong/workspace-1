<%@page import="ume.pareva.uk.CompetitionMessage"%>
...
CompetitionMessage compmessage=null;
 ...
 try{
      ...
      videolistuk=(VideoListUK) ac.getBean("videolistuk");
	   ...
	   networkMapping=(NetworkMapping) ac.getBean("networkMapping");
           ...
           compmessage=(CompetitionMessage) ac.getBean("competitionmessage");
...
FileLoader ukquiz_template_loader = new FileLoader();
//za_template_loader.setPrefix("/opt/pareva/templates/parsed/ZA/x-rated");
ukquiz_template_loader.setPrefix(templatefolder.trim());
ukquiz_template_loader.setSuffix(template.getSuffix().trim());
engine = new PebbleEngine(ukquiz_template_loader);
EscaperExtension escaper = engine.getExtension(EscaperExtension.class);
escaper.setAutoEscaping(false);
this.getServletContext().setAttribute("ukquiz_engine",engine);
System.out.println("pfiquiz "+templatefolder.trim()+"  "+template.getSuffix().trim());
//***************************************************************************************************
%>

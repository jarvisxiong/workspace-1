        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Competitions</span>
                </div>
                <!--<div class="actions">
            ...
            <div class="portlet-body">
                ...
                <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
	                ...
	                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="questionPackTable" >
			            ...
			            <thead>
			                <tr>
			                    <th style="width: 150px;"> aUnique</th>
			                    <th> Market </th>
	                    ...
	                    <tbody>
		       				<c:forEach items="${competitions}" var="competition">
						        <tr class="gradeX" role="row"> 
									<td>
										<c:out value="${competition.competition.aUnique}" />
									</td>
									<td>
										<c:out value="${competition.competition.aMarket}" />
									</td>
									<td>
										<c:out value="${competition.competition.aName}" />
									</td>
									<td>
										<img class="flag" 
										src="http://admin.pareva.umelimited.com/static/AdminPanel/assets/global/img/flags/<c:out value="${competition.competitionLanguage.toLowerCase()}" />.png"/> 
										<c:out value="${competition.competitionLanguage}" />
									</td>
									<td>
										<c:out value="${competition.numberOfQuestions}" /> 
									</td>
									<td>
										<c:out value="${competition.competition.aPeriod}" /> 
									</td>
									<td>
									<fmt:formatDate value="${competition.nextDrawDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
										<%-- <c:out value="${competition.nextDrawDate}" />  --%>
									</td>
									<td>
										<a href="../competitionadmin/edit.jsp?action=Update&unique=${competition.competition.aUnique}" class="btn btn-xs green js_loadURL" data-url="">
									...
									<td>
									<c:choose>
  										<c:when test="${competition.competition.aStatus}">
											<c:out value="Active"/>
											  </c:when>
											<c:otherwise>

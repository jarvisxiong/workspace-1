...
String selectQuery = "select aHashcode,aCampaignId,cpacampaignid,clickid,aSrc from cpavisitlog where transaction_id='"
	...
	if ((status_imi.equalsIgnoreCase("1")) && (CampaignId != null && CampaignId.trim().length() > 0)) {
		...
		if (campaignsrc.equalsIgnoreCase("BitterCPA")) {
			...
			callBackBitterStraw(dbsession,"6", "EUR", "pps", MSISDN, clubid,CampaignId, hashcode);
                         responsecode = "001";
			}
			...
			callBackMundoMedia(dbsession,"3.25", "EUR",clubid, CampaignId, MSISDN,clickid, cpacampaignid, "mundopps");
                    ...
                    boolean notified=checkMsisdn(dbsession, MSISDN);
			...
			callBackRethula(dbsession,"6", "EUR", clubid, CampaignId, MSISDN,clickid, cpacampaignid, "rethulpps");
                         responsecode = "001";
		}

       else if (campaignsrc.equalsIgnoreCase("MountWilsonCPA")) {

			callBackMountWilson(dbsession,"6", "USD", clubid, CampaignId, MSISDN,clickid, cpacampaignid, "mtwilsonpps");
                         responsecode = "001";
		}
			...
			callBackMobSuite(dbsession,"4.50", "USD", "UK", MSISDN,clubid,CampaignId, hashcode);
                     ...
                     else if (campaignsrc.equalsIgnoreCase("MobafillCPA")) {		

			callBackMobafillCPA(dbsession,"3.25", "USD",clubid, CampaignId, MSISDN,clickid, cpacampaignid, "pps");
                         responsecode = "001";
		...
		logtoBi(dbsession,SdcMisc.generateUniqueId(), "imi", status_imi,
				...
				imiNetworkid, MSISDN, contentprice, "club", clubid, CampaignId);
		...
		logtoBi(dbsession,SdcMisc.generateUniqueId(), "imi", status_imi,
				reference_id, "success", "00", "successful", "UK",imiNetworkid, "", contentprice, "club", clubid, "");
	}
...
<%!
public boolean checkMsisdn(Session dbsession, String msisdn)
{
    boolean notified=false;
    String sqlstr = "Select * from cpaLog where aParsedMobile='"+ msisdn+"' LIMIT 1";
    Query query=null;
    try{

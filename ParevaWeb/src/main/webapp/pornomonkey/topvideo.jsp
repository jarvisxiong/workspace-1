...
java.util.List list = new VideoContent().getTopVideoList(dbsession,"", domain, UmeTempCmsCache.clientDomains.get(domain));
System.out.println("TOP VIDEO LIST "+list.size());
String[] props = null;

...
if (!add.equals("")) {
    ...
    if (owner.equals("")) statusMsg = "Please select Client.";
        ...
        banner = CmsDaoFactory.getBannerAdDao().addBanner(owner, title);
        
        try { Misc.cxt.getRequestDispatcher("/ManageAds/itemdetails.jsp?add=1&unq=" + banner.getUnique()).forward(request,response); }
...
List banners = CmsDaoFactory.getBannerAdDao().getAllBanners(ss);
   ...
   <ul id="<%=itemlist%>" style="list-style-type: none; padding: 0; margin: 0;">
        ...
        for (int i=0; i<banners.size(); i++) {
            ...
            if (img.equals("")) {
                for (int k=0; k<clients.size(); k++) {
                    ...
                    if (client.getUnique().equals(banner.getClientUnique())) {
    ...
    <table cellpadding="4" cellspacing="0" border="0" width="100%" class="tableview">
        <tr>
            ...
            <td valign="middle" align="left" width="100"><%=Anyxsdk.userGroupNames.get(banner.getClientUnique())%></td>

                                ...
                                <ul class="dropdown-menu pull-right countryHolder">
                                  ...
                                  <c:forEach items="${languageList}" var="language">
                                    ...
                                    <li>
                                        ...
                                        <img class="flag" src="/lib/templates/static/AdminPanel/assets/global/img/flags/${language.toLowerCase()}.png"/>
                                        ${language}
	                                    </a>
	                                </li>
                                    ...
                                    <li>
                                        ...
                                        class="js_countrySelect" 
                                        data-country="uk">
                                        <img class="flag" src="/lib/templates/static/AdminPanel/assets/global/img/flags/uk.png"/>
                                        English
	                                    </a>
	                                </li>
	                                ...
	                                <li>
                                        ...
                                        class="js_countrySelect" 
                                        data-country="uk">
                                        <img class="flag" src="/lib/templates/static/AdminPanel/assets/global/img/flags/fr.png"/>
                                        French
	                                    </a>
	                                </li>
	                                ...
	                                <li>
                                        ...
                                        class="js_countrySelect" 
                                        data-country="uk">
                                        <img class="flag" src="/lib/templates/static/AdminPanel/assets/global/img/flags/it.png"/>
                                        Italian
	                                    </a>
	                                </li>

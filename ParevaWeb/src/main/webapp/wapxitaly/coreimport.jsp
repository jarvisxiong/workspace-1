...
<%@page import="ume.pareva.ipx.extra.IpxBroadcastSmsLogDao"%>
<%@page import="ume.pareva.ipx.extra.IpxSisterSmsLog"%>
<%@page import="ume.pareva.ipx.extra.IpxSisterSmsLogDao"%>
<%@page import="com.ipx.www.api.services.onlinelookupapi10.*, com.ipx.www.api.services.onlinelookupapi10.types.*,
 		java.lang.Math, java.net.URL, java.rmi.RemoteException,
                com.ipx.www.api.services.subscriptionapi40.types.*, com.ipx.www.api.services.subscriptionapi40.*,

...
subscriptionFile = "IPX_subscription.csv";
debugPath = "/var/log/pareva/IT/ipxlog/subscription/";
...
transactionId = (String) session.getAttribute("ipx_transactionid");
operator = (String) session.getAttribute("ipx_operator");
msisdn = (String) session.getAttribute("ipx_msisdn");
ServiceMetaData = (String)session.getAttribute("clubServiceMetadata");

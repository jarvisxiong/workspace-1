...
UmeDomain getSisterClubDomain(MobileClub club, MobileClubDao mobileclubdao, UmeUser user, UmeTempCache umesdc) {
    java.util.List <UmeDomain> list = getNotSubscribedClubDomains(club, mobileclubdao, user, umesdc);
...
java.util.List getNotSubscribedClubDomains(MobileClub club, MobileClubDao mobileclubdao, UmeUser user, UmeTempCache umesdc) {
    ...
    if (sisterClubList.size() > 0 && sisterClubList != null) {
        for (String sisterClubUnique : sisterClubList) {
            MobileClub sisterClub = mobileclubdao.getMobileClubMap().get(sisterClubUnique);
            if (user != null) {
...
CreateSubscriptionResponse threeOperatorSubscriptionRequest(String transactionId, String msisdn, 
        String operator, String ServiceMetaData, String clubUnique, String clubIPXUserName, String clubIPXPassword,  SubscriptionApiPort   myApi,
        MobileClub club) throws ServletException,
    RemoteException {
...
CreateSubscriptionSessionResponse iFrameOperatorSubscriptionRequest(String transactionId, String msisdn, String operator, String ServideMetaData, String clubUnique, String clubIPXUserName, String clubIPXPassword,  SubscriptionApiPort  myApi, String aDeliveryURL, MobileClub club) throws ServletException,
    ...
    if(clubIPXUserName.equals("umecip-it") && operator.equals("three"))
        aCreateSessionRequest.setTariffClass("EUR150");
    else
        aCreateSessionRequest.setTariffClass("EUR250");
    aCreateSessionRequest.setFrequencyCount(2);
    
    aCreateSessionRequest.setServiceName(club.getClubName());
    aCreateSessionRequest.setServiceId(club.getClubName());
    aCreateSessionRequest.setServiceId("#NULL#");
    ...
    */
    System.out.println("*********** serviceId: " + aCreateSessionRequest.getServiceId());
...
//            aCreateSessionRequest.setServiceMetaData(ServideMetaData);
        ...
        String serviceMetadataThree = "serviceurl=landingpage1;" + ServideMetaData;
        //"serviceurl=landingpage1;service=ume"
        aCreateSessionRequest.setServiceMetaData(serviceMetadataThree);
        aCreateSessionRequest.setServiceName("test");
    }
    else
        aCreateSessionRequest.setServiceMetaData("#NULL#");
...
CreateSubscriptionSessionResponse iFrameThreeSubscriptionRequest(String transactionId, String msisdn, String operator, String ServideMetaData, String clubUnique, String clubIPXUserName, String clubIPXPassword,  SubscriptionApiPort  myApi, String aDeliveryURL, MobileClub club) throws ServletException,
        RemoteException {
    CreateSubscriptionSessionRequest aCreateSessionRequest = new CreateSubscriptionSessionRequest();    
    aCreateSessionRequest.setCorrelationId(transactionId);
    aCreateSessionRequest.setClientIPAddress("#NULL#");
    ...
    */
    ...
    /*
      <typ:serviceMetaData>serviceurl=landingpage1;service=ume</typ:serviceMetaData>
         <typ:serviceName>test</typ:serviceName>
    ...
    */
    ...
    if(operator.equals("tim")){
        ...
        aCreateSessionRequest.setServiceMetaData("serviceurl=landingpage1;service=ume");
        aCreateSessionRequest.setServiceName("test");
    }
    else
        aCreateSessionRequest.setServiceMetaData("#NULL#");
...
String finalizeSubscription(String aSessionId, String corrId, String clubIPXUserName, String clubIPXPassword, SubscriptionApiPort myApi, StringBuilder dd, String crlf, HttpSession session)
        ...
        if (aFinalizeSessionResponse.getResponseCode() != 0) {
            ...
            System.out.println(MiscDate.now24sql() + " IPX Subscription Delivery Failed finalize session, response: "
                            ...
                            + aFinalizeSessionResponse.getResponseMessage()
                            + ")");
            session.setAttribute("ipx_responseCode", aFinalizeSessionResponse.getResponseCode());
            session.setAttribute("ipx_responseMessage", aFinalizeSessionResponse.getResponseMessage());
            
            if(aFinalizeSessionResponse.getResponseMessage().contains("subscriber is blocked") 
                    && aFinalizeSessionResponse.getOperator().equalsIgnoreCase("tim"))
...
//RevShareLoggingDao revvisitorlogdao=null;
...
//    revvisitorlogdao=(RevShareLoggingDao) ac.getBean("revsharevisitorlogdao");
//    revsharepartnersdao=(RevSharePartersDao) ac.getBean("revsharepartnerdao");
    zalogDao = (ZACPA) ac.getBean("zacpa");

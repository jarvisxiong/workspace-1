...
videoParameter=videolist.getVideoCategory(video_category_list.get(0).toString(),domain,handset);
...
videos=videos=videolist.getVideos(index,video_category_list.get(0).toString(),domain,handset,number_of_elements,lang);

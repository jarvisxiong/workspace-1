...
<%
try {
System.out.println("xstreamdllink  FromDEfaultServlet called upon ");
...
dmn = aReq.getDomain();
service = aReq.getService();
String msisdn = "";
String operator = "";
domain = dmn.getUnique();
lang = aReq.getLanguage().getLanguageCode();
String stylesheet = aReq.getStylesheet();
String pageEnc = aReq.getEncoding();

//***************************************************************************************************

dParamMap = UmeTempCmsCache.domainParameters.get(domain);
...
if (contentItem!=null) {
    ...
    itemTicket = zaitemtickets.get(contentItem, client.getUnique(), msisdn, logUnique, cType, iType, iLang, iParam, "x-stream.celldirect.mobi");

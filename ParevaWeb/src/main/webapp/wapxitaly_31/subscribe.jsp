...
SubscriptionApiPort myApi = new SubscriptionApiServiceLocator().getSubscriptionApi31(new URL(SUBSCRIBE_REQUEST_URL));
...
if (transactionId != null && msisdn != null && operator!=null) {
	...
	try {
		...
		if( (operator.equals("vodafone") || operator.equals("wind") || operator.equals("tim"))  && webpin.equals("")){
		//if( (operator.equals("vodafone") || operator.equals("wind") || operator.equals("tim"))){
			...
			CreateSubscriptionResponse aResponse = 
				threeOperatorSubscriptionRequest(transactionId, msisdn, operator, ServiceMetaData, clubUnique, clubIPXUserName, clubIPXPassword, myApi);

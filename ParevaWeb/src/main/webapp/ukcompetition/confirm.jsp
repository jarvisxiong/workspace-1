...
if(validMsisdn){
    System.out.println("quiz2winlanding page "+validMsisdn);
	...
	if (user!=null) {
	    ...
	    if ((clubUser!=null && clubUser.getActive()!=1) ||(clubUser==null)) {
	    	...
	    	compmessage.requestSendSmsTimer(toAddress,freeCostId,serviceId,deliveryReceipt,msg,shortCode,transactionId,typeId,club,umesmsdao,30*1000,true);
		    ...
		    engine.getTemplate("confirm").evaluate(writer, context);  //a
	    	    	
	 
	    }else{
                System.out.println("quiz2winlanding page "+clubUser.getParsedMobile()+"  "+clubUser.getActive());
	    	...
	    	engine.getTemplate("confirm").evaluate(writer, context);  
	    }
	}else{  // New User 
            //campaigndao.log("ukconfirm", confirmlanding, msisdn,msisdn, handset,domain, campaignId, club.getUnique(), "MANUAL", 0, request,response,myisp);
		String[] toAddress={msisdn};
...
<%!
public boolean sendSMS(String[] msisdn, String costId,String serviceId, String deliveryReceipt, String msgText, String shortCode,String transactionId, String typeId,MobileClub club,UmeSmsDao umesmsdao){

...
UmeMobileClubUserDao sdcmobileclubuserdao=null;
...
ItemTicket itemtickets=null;
 try{
	  ...
	  sdcmobileclubuserdao=(UmeMobileClubUserDao)ac.getBean("umemobileclubuserdao");
...
return;
} catch (Exception e) { System.out.println("fromDefaultServlet: Uknew " + e); e.printStackTrace();}
%>
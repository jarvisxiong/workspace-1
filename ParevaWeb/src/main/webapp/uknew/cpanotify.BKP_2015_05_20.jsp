	...
	public String callBackMundoMedia(Session dbsession,String amount, String currency,
		...
		try {
			...
			String postbackclickid ="?clickID="+ java.net.URLEncoder.encode(clickid, "UTF-8");
                        postbackclickid+="&idcallback="+ java.net.URLEncoder.encode("6b845edc863e643a2067e27e4f1153e2", "UTF-8");
		...
		return response;
         ...
         //MobafillCPA==================
          ...
          public String callBackMobafillCPA(Session dbsession,String amount, String currency,
			String clubid, String campainId, String MSISDN, String clickId,
			String cpaCampaign, String payoutType) {
		String postbackcampaignid = "";
		String response = "";
		...
		try {
                    ...
                    Calendar dcal = Calendar.getInstance();
			Date curdate = dcal.getTime();
			String currentTime = sdf.format(curdate.getTime());

			String clickid = clickId;
			String cpacampaign = cpaCampaign;
			String postbackclickid ="?tracker_id=="+ java.net.URLEncoder.encode(clickid, "UTF-8");
                        postbackclickid += "&payout="+ java.net.URLEncoder.encode(amount, "UTF-8");
                        postbackclickid += "&currency="+ java.net.URLEncoder.encode(currency, "UTF-8");
                        postbackclickid += "&date="+ java.net.URLEncoder.encode(currentTime, "UTF-8");
			mobideatrackingurl = new java.net.URL("http://umelimited.api.mobafill.net/"+ postbackclickid);
			...
			String desc = mobideapostback.getResponseMessage();
			response = code + ":" + mobideapostback.getResponseCode();
			System.out.println("MobafillCPA tracking URL: " + mobideatrackingurl);

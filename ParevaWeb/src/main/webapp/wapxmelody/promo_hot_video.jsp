...
<%
request.setAttribute("pagename","promo_hot_video.jsp");
...
{
    request.getServletContext().getRequestDispatcher("/wapxza/promo_subscribe.jsp?redir=videojsp").forward(request, response);
...
<%
	...
	videoParameter=videolist.getVideoCategory(video_category_list,domain,handset);
        }catch(Exception e){System.out.println("Exception for ZA domain at line 102 "+domain+ " "+e);}
	...
	number_of_elements=Integer.parseInt(videoParameter.get("number_of_elements").toString());
        }catch(Exception e){number_of_elements=10;}

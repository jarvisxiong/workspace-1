<%@ page import="com.mixmobile.anyx.sdk.*, java.util.Properties, java.io.File" %>
...
<tr><td colspan="<%=cs%>"><img src="/images/red_dot.gif" height="1" width="100%"></td></tr><tr>
	<td colspan="<%=cs%>">You are not authorized to use this service.<br></td>
</tr>

...
<tr><td valign="top" align="left">
 ...
 <%-----------------------------------------------------------------------------------------------------------------------%>	
	...
	<td align="left">
            ...
            <select name="template_theme" id="template_theme" onChange="javascript:form_submit(this.form);">
            <option value=" " selected>Select Template Theme</option>
			<option value="Template1" <% if (template_theme.equals("Template1")){%> selected <%}%>>Template1</option>
			</select>
...
--%>	
	...
	<td align="left">
			...
			<option value="Index" <% if (template_page.equals("Index")){%> selected <%}%>>Index</option>
...
--%>	
	...
	<tr>
	<td align="left" class="grey_12"><b>Add Page:</b></td>
	...
	<td align="left">
            ...
            <select name="add_page" id="add_page" onChange="javascript:form_submit(this.form);">
            <option value=" " selected>Page Type</option>
			<option value="Text" <% if (template_page.equals("Text")){%> selected <%}%>>Text</option>
			<option value="Landing" <% if (template_page.equals("Landing")){%> selected <%}%>>Landing</option>
			<option value="Index" <% if (template_page.equals("Index")){%> selected <%}%>>Index</option>
			</select>
            ...
            <tr>
                ...
                <%-----------------------------------------------------------------------------------------------------%>    
                    ...
                    <select name="number_of_elements" id="number_of_elements">
            			<option value=" " selected>Number Of Elements</option>
						<% 
						for(int number_of_elements=1;number_of_elements<=10;number_of_elements++){
							%>
							<option value="<%=number_of_elements%>" <% if (template_page.equals(number_of_elements)){%> selected <%}%>><%= number_of_elements%></option>
							<%} %>
					</select>
                </td>
...
<tr><td valign="top" align="left">
    ...
    <table cellspacing="0" cellpadding="10" border="0" class="tableview" width="100%">
        <tr>
            ...
            <th width="150" align="left" class="grey_12"><nobr><b>Element Type</b><img src="/images/glass_dot.gif" width="30" height="1"></nobr></th>
            <th width="160" align="left" class="grey_12"><b>Name</b></th>
            <th width="70" align="center" class="grey_12"><b>Active</b></th>
            <th width="80">&nbsp;</th>

<%     
    ...
    _items[0][0] = "Properties"; _items[0][1] = "/itemadmin/java/itemdetails.jsp";
    ...
    _items[5][0] = "Phone Support"; _items[5][1] = "supphones_list.jsp";    
    //_items[6][0] = "Game Files"; _items[6][1] = "/itemadmin/java/updatephones.jsp?ftype=game";
   // _items[7][0] = "Demo Files"; _items[7][1] = "/itemadmin/java/updatephones.jsp?ftype=demo";

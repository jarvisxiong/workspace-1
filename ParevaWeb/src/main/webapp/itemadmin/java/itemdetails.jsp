<%@include file="/WEB-INF/jspf/itemadmin/java/itemdetails.jspf"%>
<html>
<head>
...
<% if (!delete.equals("") && (adminGroup.equals("9") || item.getOwner().equals(ugid))) { %>
	...
	Are your sure you want to permanently delete this game?
	</b>
	</td></tr>
	<tr><td  align="left" valign="bottom" class="normal_blue"><br>
	<a href="/itemadmin/deleteitem.jsp?unq=<%=unique%>&itype=java"><b>DELETE</b></a>
	&nbsp;&nbsp;&nbsp;&nbsp;
...
<td valign="top" align="left">      
	...
	<tr>
	<td class="grey_11">Game Title:</td>
	...
	<td class="grey_11">
            ...
            <tr>
            <td class="grey_11">1:</td><td><input type="text" size="20" name="name1" class="textbox" value="<%=item.getName1()%>"></td>
            <td class="grey_11">2:</td><td><input type="text" size="20" name="name2" class="textbox" value="<%=item.getName2()%>"></td>
            </tr>
            <tr>
            <td class="grey_11">3:</td><td><input type="text" size="20" name="name3" class="textbox" value="<%=item.getName3()%>"></td>
            <td class="grey_11">&nbsp;</td>
            </tr>
            </table>
	</td></tr>
        ...
        <!--
        <tr>
	<td class="grey_11" valign="top">Jar/Jad Location (URL):</td>
	<td><input type="text" name="jarloc" value="<%=item.getJarLocation()%>" size="50"></td>
	</tr>
        
        <tr>
	<td class="grey_11" valign="top">Demo Location (URL):</td>
	<td><input type="text" name="demoloc" value="<%=item.getDemoLocation()%>" size="50"></td>
	</tr>
-->
	<tr>

<%@include file="/WEB-INF/jspf/itemadmin/truetone/itemdetails.jspf"%>
<html>
<head>
...
<% if (!delete.equals("") && (adminGroup.equals("9") || item.getOwner().equals(ugid))) { %>
    ...
    <a href="/itemadmin/deleteitem.jsp?unq=<%=unique%>&itype=truetone"><b>DELETE</b></a>
    &nbsp;&nbsp;&nbsp;&nbsp;
...
<tr><td valign="top" align="left">
    ...
    <tr>
        <td align="left" valign="bottom" class="blue_14"><b>Truetone Details: </b> <span class="grey_12"><b><%=item.getSongName()%></b></span></td>
...
<td valign="top" align="left">      
    ...
    <td class="grey_10"><a href="datafile.jsp?tone=<%=Misc.hex8Code(item.getSampleFile())%>"><%=item.getSampleFile()%></a></td>
    </tr>
    ...
    <option value="1" <% if (item.getToneType().equals("1")){%> selected <% } %>>Cover Song</option> 
    <option value="2" <% if (item.getToneType().equals("2")){%> selected <% } %>>Funtone</option>
    </select>
    </td>
    </tr>
    ...
    <tr>
    <td class="grey_11">Active:</td>
    <td class="grey_11">
    <input type="radio" name="publ" value="1" <% if (item.getStatus()==1){%> checked ><span class="green_12"><b>YES</b></span><% } else {%>>Yes <%}%>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="publ" value="2" <% if (item.getStatus()!=1){%> checked ><span class="red_12"><b>NO</b></span><% } else {%>>No <%}%>

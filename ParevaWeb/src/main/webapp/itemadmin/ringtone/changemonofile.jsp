<%@include file="/WEB-INF/jspf/itemadmin/ringtone/changemonofile.jspf"%>
<html>
<head>
...
<tr><td valign="top" align="left">
    ...
    <tr>
        <td align="left" valign="bottom" class="blue_14"><b>Update Monophonic Files:</b> <span class="grey_12"><b><%=item.getSongName()%></b></span></td>
        <td align="right" valign="bottom" class="status">&nbsp;<%=statusMsg%></td>
    </tr>
    </table>
</td></tr>
<tr><td valign="top" align="left">
    <% int _curitem = Integer.parseInt(aReq.get("_curitem", "2")); %>
...
<tr><td>
    ...
    <tr>
    <td class="grey_11" colspan="2"><b>NOTE! This field is only for MIDI or OTA files.</b> </td>
    </tr>
    <tr>
    <td class="grey_11">MIDI/OTA File:</td>
    <td><input type="file" size="30" name="ddata" class="textbox" value=""></td>
    </tr>
    <tr>
            <td>&nbsp;</td>
        <td><textarea name="otatext" cols="40" rows="3" class="textbox"></textarea></td>
    </tr>
    <tr>

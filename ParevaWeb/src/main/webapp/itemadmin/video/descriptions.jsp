<%@include file="/WEB-INF/jspf/itemadmin/video/descriptions.jspf"%>
<html>
<head>
...
<tr><td valign="top" align="left">
    ...
    <tr>
        <td align="left" valign="bottom" class="blue_14"><b>Video Clip Details: </b> <span class="grey_12"><b><%=orgTitle%></b></span></td>
...
<tr><td valign="top" align="left">
    ...
    <tr>    
        ...
        <td align="left">
            ...
            %>
            <option value="<%=langs[i][1]%>" <% if (langCode.equals(langs[i][1])){%> selected <%}%>><%=langs[i][0]%> (<%=langs[i][1]%>)</option>
...
<tr><td valign="top" align="left">
    ...
    <table cellspacing="0" cellpadding="8" border="0">        
      <tr>    
        <td align="left" class="grey_12" valign="top"><nobr><b>Video Title:</b></nobr></td>	
        <td align="left">

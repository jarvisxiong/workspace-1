...
String datadir = System.getProperty("installDir") + "/data/videoclips";
String statusMsg1 = "";
...
if (!aReq.get("del").equals("")) {
    ...
    for (;e.hasMoreElements();) {
        ...
        if (elem.startsWith("sel_")) CmsDaoFactory.getItemResourceDao().deleteItem(elem.substring(4));
    }
}

VideoClip item = CmsDaoFactory.getVideoClipDao().getItem(unique);

ItemResource res = null;
List<ItemResource> list = null;

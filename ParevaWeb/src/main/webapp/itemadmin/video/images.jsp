<%@include file="/WEB-INF/jspf/itemadmin/video/images.jspf"%>
         ...
         <tr bgcolor="#EEEEEE"><td class="blue_11" align="left" colspan="2">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;Type:
              <select name="type_<%=img.getUnique()%>">             
                <option value="<%=imgType%>thumb" <%if (key.equals(imgType + "thumb")){%> selected <%}%>>Thumbnail</option> 
...
<%	
	...
	for (int i=0; i<images.size(); i++) {
           ...
           System.out.println("IMAGES PATH IN IMAGE .JSP "+im.getPath());

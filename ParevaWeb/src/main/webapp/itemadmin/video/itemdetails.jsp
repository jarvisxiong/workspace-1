<%@include file="/WEB-INF/jspf/itemadmin/video/itemdetails.jspf"%>
...
<td valign="top" align="left">      
    ...
    <tr>
    <td class="grey_11">TIM Id:</td>
    <td><input type="text" name="timUrl" class="textbox" value="<%=item.getDataFile1()%>" style="width:350px;"></td>
    </tr>

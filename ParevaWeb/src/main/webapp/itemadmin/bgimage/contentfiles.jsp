<%@include file="/WEB-INF/jspf/itemadmin/bgimage/contentfiles.jspf"%>
<html>
    <head>
    ...
    function updateUploader() {
        ...
        $upload.uploadifySettings('scriptData', {'itemunq':'<%=unique%>', 'type':'bgres'});
    ...
    $(document).ready(function() {
         ...
         $('#file_upload').uploadify({
             ...
             'scriptData': {'itemunq':'<%=unique%>', 'type':'bgres'},
             'method'    :'GET',
...
<tr><td valign="top" align="left">
    ...
    <tr>
        <td align="left" valign="bottom" class="blue_14"><b>Bg Image Details: </b> <span class="grey_12"><b><%=item.getTitle()%></b></span></td>

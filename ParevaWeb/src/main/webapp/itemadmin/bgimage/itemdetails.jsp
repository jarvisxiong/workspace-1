<%@include file="/WEB-INF/jspf/itemadmin/bgimage/itemdetails.jspf"%>
<html>
<head>
...
<% if (!delete.equals("") && (adminGroup.equals("9") || item.getOwner().equals(ugid))) { %>
    ...
    <a href="/itemadmin/deleteitem.jsp?unq=<%=unique%>&itype=bgimage"><b>DELETE</b></a>
    &nbsp;&nbsp;&nbsp;&nbsp;
...
<tr><td valign="top" align="left">
    ...
    <tr>
        <td align="left" valign="bottom" class="blue_14"><b>BgImage Details: </b> <span class="grey_12"><b><%=item.getTitle()%></b></span></td>
...
<tr><td valign="top" align="left">
    ...
    <%@ include file="/itemadmin/bgimage/tabs.jsp" %>
    <br>
</td></tr>
...
<td valign="top" align="left">      
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="publ" value="0" <% if (item.getStatus()==0){%> checked <% } %>>Hidden
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="publ" value="2" <% if (item.getStatus()==2){%> checked <% } %>>No
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="publ" value="3" <% if (item.getStatus()==3){%> checked <% } %>>Copyright
    </b>
    </td>
    </tr>
    <%}%>

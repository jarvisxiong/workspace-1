...
if(notSubscribedClubDomains!=null &&!notSubscribedClubDomains.isEmpty()){
	...
	String popunderCampaignId=campaigndao.getCampaignUnique(popunderDomain.getUnique(),"Pop Under");
	System.out.println("Popunder Domain: "+"http://"+popunderDomain.getDefaultUrl()+"/?id=" + user.getWapId()+"&mid="+enMsi+"&logtype=redirect&cid="+popunderCampaignId);
	context.put("popunderDomain","http://"+popunderDomain.getDefaultUrl()+"/?id=" + user.getWapId()+"&mid="+enMsi+"&logtype=redirect&cid="+popunderCampaignId);
}

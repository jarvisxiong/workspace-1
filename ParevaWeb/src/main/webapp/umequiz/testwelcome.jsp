...
String msg=club.getWelcomeSms();//userClubDetails.getTeaser();
...
if(validMsisdn){
	...
	if (user!=null) {
	    ...
	    if ((clubUser!=null) ||(clubUser==null)) {
	    	...
	    	compmessage.requestSendSmsTimer(toAddress,freeCostId,serviceId,deliveryReceipt,msg,shortCode,transactionId,typeId,club,umesmsdao,10*10,true);
                    System.out.println("quizdebugwelcome sent quiz to user "+toAddress+" CLUBUSER is null");

...
session.setAttribute("videoDownloaded","true");
...
System.out.println("PRICE:  item getPrice group  "  + item.getPriceGroup());

String price = (String) UmeTempCmsCache.domainPriceGroups.get(domain + "_" + item.getPriceGroup());
System.out.println("PRICE: videodetail pricing "  + price);
...
if (desc==null) desc = "";
System.out.println("AUdebug  download link "+dllink);

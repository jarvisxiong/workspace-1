...
<%
	aReq = (UmeSessionParameters)request.getAttribute("aReq");	
	...
	dParamMap=(Map<String,String>)request.getAttribute("dParamMap");
	PebbleEngine za_engine=(PebbleEngine)request.getAttribute("za_engine");
	wapid=(String)request.getAttribute("wapid");
	...
	uniqueBanners=videolist.getBanner(bannerSrvc,dmn,handset,club.getClassification(),"DE");

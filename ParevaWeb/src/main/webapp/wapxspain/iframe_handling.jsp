...
<%
    ...
    String crlf = "\r\n";
    String debugFile = "IPX_tricky_subscription_log_debug_" + MiscDate.sqlDate.format(new Date()) + ".txt";
    ...
    try{
        ...
        try {
            ...
            out.write("http://subscription.purebros.it" + newsHeadlines.attr("href").toString()+ referenceParam);
            
            dd.append(crlf + "IPX Trikcy debug vodafoneRedirectURL: " + vodafoneRedirectURL + "---msisdn: " + aReq.get("msisdn"));
            dd.append(crlf + "http://subscription.purebros.it" + newsHeadlines.attr("href").toString()+ referenceParam);

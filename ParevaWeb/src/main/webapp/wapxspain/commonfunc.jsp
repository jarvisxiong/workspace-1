    ...
    try {
        ...
        ResolveClientIPResponse responseLookUpIP = myApi.resolveClientIP(requestLookUpIP);
           ...
           if(responseLookUpIP.getResponseCode()!=0){
                ...
                if(!responseLookUpIP.getOperator().equals("") && responseLookUpIP.getCountryName().equals("Spain")){
                    isIdentified = true;
...
CreateSubscriptionResponse directOperatorSubscriptionRequest(String transactionId, String msisdn, String operator, String ServiceMetaData, String clubUnique, String clubIPXUserName, String clubIPXPassword,  SubscriptionApiPort myApi) throws ServletException,
    RemoteException {
    ...
    aCreateRequest.setServiceName("Erotixxxo");
//    aCreateRequest.setServiceName("Erotixxxo Mas Info: 900809734");
    ...
    if(operator.equals("tim")){
      ...
      aCreateRequest.setServiceMetaData(ServideMetaData);
    }   
    ...
    */
    ...
    //aCreateRequest.setTariffClass("EUR499ES");
    aCreateRequest.setTariffClass("EUR412ES");
    aCreateRequest.setFrequencyCount(1);
    aCreateRequest.setVAT(-1);

    aCreateRequest.setServiceId("Erotixxxo");

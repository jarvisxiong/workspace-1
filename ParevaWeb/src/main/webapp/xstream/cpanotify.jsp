...
public String getOperatorName(String code) {
	...
	String findClub(Session dbsession,String campaignid) {
     ...
     public boolean logtoCpaLogging(ZACPA zacpa,String msisdn, String src,
		...
		String currentTime = sdf2.format(curdate.getTime());
                String nextpush=currentTime;
                if(clubunique.equalsIgnoreCase("9062764922341KDS")){
                    dcal.add(Calendar.MINUTE, 10);
                    Date nextqueue = dcal.getTime();
	            nextpush=sdf2.format(nextqueue.getTime());
                }
                int ukstatus=0;

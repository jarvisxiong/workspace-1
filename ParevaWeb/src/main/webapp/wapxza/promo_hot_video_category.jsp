...
<%
	...
	System.out.println("AUdebug ZA getvideos  the size of videoParameter is "+videoParameter.size());
...
//		System.out.println("list size = "+list.size());
	...
	java.util.List bannerSrvc=(java.util.List)session.getAttribute("promo_banner_list");
        System.out.println("AUdebug ZA the size of the bannerSrvc is "+bannerSrvc.size()+"--- domain "+domain+" bannersrvc "+bannerSrvc.get(0).toString());
        
	if(!bannerSrvc.isEmpty()) {
		uniqueBanners=videolist.getBanner(bannerSrvc.get(0).toString(),domain,"topless","ZA");
                System.out.println("AUdebug ZA BannerService Unique Banners "+uniqueBanners.size()+" -- domain "+domain+" --  bannersrvc "+bannerSrvc.get(0).toString());
        }
  ...
  if (uniqueBanners.size() > 0) {
	...
	}catch(Exception e){System.out.println("AUdebug Exception in Banner service "+e);}

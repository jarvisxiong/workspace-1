...
@Component("UK"+UmeFilter.SUFFIX)
public class UKFilter implements RegionFilter {
    
    static final Logger logger = LogManager.getLogger(UKFilter.class.getName());
...
//            System.out.println("UK_Filter PATH: " + path);
        ...
        catch(Exception e){System.out.println("UK Filter Exception "+e);e.printStackTrace();}
...
//System.out.println("INSIDE forwardRequest : value of defaultServlet "+defaultServlet +" path: "+path+" service type: "+service.getServiceType());
        	...
        	if(req!=null){
        		System.out.println("UK_Filter.forwardRequest exception req.getServerName(): " + req.getServerName());
        		System.out.println("UK_Filter.forwardRequest exception domain: " + domain);
        		System.out.println("UK_Filter.forwardRequest exception service: " + service);
        		System.out.println("UK_Filter.forwardRequest exception lang: " + lang);        		
        		System.out.println("UK_Filter.forwardRequest exception serviceType: " + serviceType); 
        		System.out.println("UK_Filter.forwardRequest exception path: " + path); 
        	}
        	
        	System.out.println("UK_Filter UmeCore.forwardRequest exception : " + e);
                e.printStackTrace();

...
@Component("NO"+UmeFilter.SUFFIX)
public class NO_Filter implements RegionFilter  {
    static final Logger logger = LogManager.getLogger(NO_Filter.class.getName());
...
//System.out.println("INSIDE forwardRequest : value of defaultServlet "+defaultServlet +" path: "+path+" service type: "+service.getServiceType());
        	...
        	if(req!=null){
        		System.out.println("NO_Filter.forwardRequest exception req.getServerName(): " + req.getServerName());
        		System.out.println("NO_Filter.forwardRequest exception domain: " + domain);
        		System.out.println("NO_Filter.forwardRequest exception service: " + service);
        		System.out.println("NO_Filter.forwardRequest exception lang: " + lang);        		
        		System.out.println("NO_Filter.forwardRequest exception serviceType: " + serviceType); 
        		System.out.println("NO_Filter.forwardRequest exception path: " + path); 
        	}
        	
        	System.out.println("NO_Filter UmeCore.forwardRequest exception : " + e);
                e.printStackTrace();

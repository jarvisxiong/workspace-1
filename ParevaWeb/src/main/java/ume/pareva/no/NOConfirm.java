 ...
 * @author madan
 */
@WebServlet(name = "NOConfirm", urlPatterns = {"/NOConfirm"})
public class NOConfirm extends HttpServlet {
    @Autowired
    ...
    UmeClubDetailsDao umeclubdetailsdao;
        ...
        private final Logger logger = LogManager.getLogger(NOConfirm.class.getName());
	...
	userClubDetails=UmeTempCmsCache.umeClubDetailsMap.get(club.getUnique());
        ...
        if(msisdn.startsWith("07") || msisdn.startsWith("08") || msisdn.startsWith("04") || msisdn.startsWith("05")
                || msisdn.startsWith("09") || msisdn.startsWith("06") || msisdn.startsWith("02")){
           msisdn="47"+msisdn.substring(1);
        }
        if(msisdn.startsWith("0047")) msisdn=msisdn.substring(2);
        ...
        System.out.println("norconfirm VALIDATION of msisdn "+msisdn+" is "+validMsisdn);
        if(validMsisdn){
        ...
        System.out.println("norconfirm VALIDATION of msisdn INSIDE CONDITION "+msisdn+" is "+validMsisdn);
	...
	if (!userUnique.equals("")) user = umeuserdao.getUser(msisdn);
        ...
        //==========END IF USER EXISTS OR NOT ============================
              ...
              System.out.println("norconfirm the value of sendTeaser is "+sendTeaser+ "For msisdn "+msisdn) ;
              if(sendTeaser){
                ...
                compmessage.requestIESendSmsTimer(toAddress,msg,shortCode,club,userClubDetails,20*10,false, campaignId);  //12000*10= 120000 - 2 mins. 

 ...
 * @author Alex
 */
public class ZAIndex extends HttpServlet {
    ...
    private final Logger logger = LogManager.getLogger(ZAIndex.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        logger.info("ZAINDEX "+"ProcessREQEST is called upon ");

        HttpSession ses = request.getSession();
        logger.info("ZAINDEX "+"session id is  "+ses.getId());
        ServletContext application = request.getServletContext(); //.setAttribute(null, request);
        logger.info("ZAINDEX "+"servletContext is  "+application.getContextPath());
        ...
        logger.info("zaindex "+" after SDC request ");
        ...
        logger.info("zaindex "+"contentUrl is  "+cloudfronturl);
        ...
        if (!notSubscribedClubs.equals("")) {
            ...
            ses.setAttribute("sisterClubUrlList", notSubscribedUrlList);
        }
   ...
   //=====  GET the IP Address of Visitor ============================
        ...
        if (club != null) {
            ...
            if(club.getUnique().equalsIgnoreCase("1980058743641KDS"))
                System.out.println("zacompetition ZAIndex is "+club.getUnique()+"  details is "+userclubdetails.getServiceType());
        }
        ...
        */
        ...
        try {
            ...
            networkname = mobilenetwork.getMobileNetwork("ZA", networkname);

            System.out.println("zaindex JSP LOGGING BEFORE logging " + subpage + " mroute " + aReq.get("mroute"));
            if (!subpage.equals("subscribe")) {
                System.out.println("ZA INDEX JSP LOGGING TO CAMPAIGN LOG ");
                if (!aReq.get("cid").equalsIgnoreCase("") && (ses.getAttribute("doneMsisdnParse")==null) && request.getParameter("loghits")==null) {
                    if(ses.getAttribute("referrer")!=null) //
                    {
                        response.setHeader("Referer", (String)ses.getAttribute("referrer")); //
                    }
                    campaigndao.log("index", landingPage, msisdn, msisdn, handset, domain, campaignId, clubUnique, "INDEX", 0, request, response, networkname,"","","",pubId);
               ...
               /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////             
                         if(cmpg!=null&&!cmpg.getaInterstitialLandingPage().equals("")&& cmpg.getaInterstitialLandingPage()!=null && request.getParameter("loghits")==null){  
                          ...
                          String redirectBack=URLEncoder.encode("http://"+dmn.getDefaultUrl(),"UTF-8");
                          if(interstitialRedirected==null){
                           ...
                           ses.setAttribute("clubid",club.getUnique());
                           ses.setAttribute("redirectback",redirectBack);
                           ses.setAttribute("interstitiallandingpage", interstitialLandingPage);
                           String params="?redirectback="+redirectBack+"&cid="+cid+"&clubid="+clubId+"&interstitiallandingpage="+interstitialLandingPage+"&interstitialredirected=1";
        ...
        try {
            ...
            if (user != null) {
                ...
                if (club.getRegion().equals("ZA")) {
                    ...
                    boolean is3G=myisp.contains("mtn") || myisp.contains("vodacom") || myisp.contains("cellc");
                    if(is3G) {
...
//System.out.println("LANDING PAGE IN INDEX.jsp "+landingPage+ " attribute "+request.getAttribute("landingPage"));
        ...
        try {
            if(club.getUnique().equalsIgnoreCase("1980058743641KDS")){
                System.out.println("zacompetition ZAIndex is "+club.getUnique()+" Redirection to index_main ");
            }

...
@Component("PT_Filter")
public class PT_Filter implements RegionFilter{
    static final Logger logger = LogManager.getLogger( PT_Filter.class.getName());
    ...
    public boolean doFilterForRegion(HttpServletRequest  req, HttpServletResponse res) throws IOException, ServletException {
        ThreadContext.put("ROUTINGKEY", "PT");
        ...
        try{
            ...
            logger.info("---PT FILTER CALLED ---- {}",domain.getDefaultUrl());
            MobileClub club = UmeTempCmsCache.mobileClubMap.get(domain.getUnique());
            
            logger.info("---{PT FILTER CALLED ---- {} Club {}",domain.getDefaultUrl(),club.getName());
            ...
            logger.info("PT FILTER PATH RECEIVED IS "+path);
...
//System.out.println("INSIDE forwardRequest : value of defaultServlet "+defaultServlet +" path: "+path+" service type: "+service.getServiceType());
            ...
            //System.out.println("FR_Filter Forwarding to /"+path);
        	...
        	if(req!=null){
        		System.out.println("PT_FILTER.forwardRequest exception req.getServerName(): " + req.getServerName());
        		System.out.println("PT_FILTER.forwardRequest exception domain: " + domain);
        		System.out.println("PT_FILTER.forwardRequest exception service: " + service);        		
        		System.out.println("PT_FILTER.forwardRequest exception user: " + user);        		
        		System.out.println("PT_FILTER.forwardRequest exception lang: " + lang);        		
        		System.out.println("PT_FILTER.forwardRequest exception serviceType: " + serviceType); 
        		System.out.println("PT_FILTER.forwardRequest exception path: " + path); 
        	}
        	
        	System.out.println("PT_FILTER UmeCore.forwardRequest exception : " + e.getMessage());
                //e.printStackTrace();
    ...
    public void evaluateIPAddress(HttpServletRequest req){
        ...
        logger.info("---IP ADDRESS IN PT FILTER  ---- {}",ipAddress);

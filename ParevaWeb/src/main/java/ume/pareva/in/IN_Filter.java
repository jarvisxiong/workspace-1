...
@Component("IN_Filter")
public class IN_Filter implements RegionFilter{
...
//        
    ...
    public boolean doFilterForRegion(HttpServletRequest  req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try{
            ...
            //System.out.println("---ZA FILTER CALLED ---- "+domain.getDefaultUrl());
            MobileClub club = UmeTempCmsCache.mobileClubMap.get(domain.getUnique());
            //System.out.println("---ZA FILTER CALLED ---- "+domain.getDefaultUrl()+" Club "+club.getName());
            ...
            user = userauthentication.authenticateUser(domain, req, res);
             ...
             if ((SdcRequest.get("anyx_kplg", req).equals("true") || !SdcRequest.get("id", req).equals("")) && user!=null && !user.getActiveClubCode().equals("")) {
                // System.out.println("Setting ANYX_KPLG Cookie: " + user.getActiveClubCode());
            ...
            //System.out.println("ZA FILTER PATH RECEIVED IS "+path);
            ...
            //==Download Link 
               if (!get("axud", req).equals("") || !get("anyx_usedef", req).equals("")) 
               {
                ...
                if (user==null) service = umesdc.getServiceMap().get(domain.getUnique() + "_pub");
                    ...
                    //System.out.println("SERVICE in path "+path +" domain unique pri "+domain.getUnique()+"_pri"+" Services in "+umesdc.getServiceMap().get(domain.getUnique() + "_pri"));
...
//            System.out.println("IN_Filter "+service.getDirectory() + ": " + service.getUnique());
//            System.out.println("IN_Filter Type: " + serviceType);
//            System.out.println("IN_Filter PATH: " + path);
...
//System.out.println("INSIDE forwardRequest : value of defaultServlet "+defaultServlet +" path: "+path+" service type: "+service.getServiceType());
            ...
            //System.out.println("IN_Filter Forwarding to /"+path);
        	...
        	if(req!=null){
        		System.out.println("IN_FILTER.forwardRequest exception req.getServerName(): " + req.getServerName());
        		System.out.println("IN_FILTER.forwardRequest exception domain: " + domain);
        		System.out.println("IN_FILTER.forwardRequest exception service: " + service);        		
        		System.out.println("IN_FILTER.forwardRequest exception user: " + user);        		
        		System.out.println("IN_FILTER.forwardRequest exception lang: " + lang);        		
        		System.out.println("IN_FILTER.forwardRequest exception serviceType: " + serviceType); 
        		System.out.println("IN_FILTER.forwardRequest exception path: " + path); 
        	}
        	
        	System.out.println("IN_Filter UmeCore.forwardRequest exception : " + e);
                e.printStackTrace();

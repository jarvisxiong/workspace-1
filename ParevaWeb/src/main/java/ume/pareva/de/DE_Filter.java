 ...
 */
@Component("DE_Filter")
public class DE_Filter implements RegionFilter {
    
     static final Logger logger = LogManager.getLogger( DE_Filter.class.getName());
...
//            System.out.println("ZA_Filter PATH: " + path);
    ...
    private void forwardRequest(UmeFilter.ServiceType serviceType, String path, UmeDomain domain, SdcService service, UmeUser user, SdcLanguage lang,
        ...
        try {
            ...
            logger.error("domain {} -- {}", req.getServerName(), e.getMessage());
        	//if(req!=null){
...
//        		System.out.println("ZA_FILTER.forwardRequest exception path: " + path); 
               ...
               logger.error("Service {} serviceType {} path={} req.getRequestURI={}",service, serviceType , (path!=null?path:"PATH IS NULL"),req.getRequestURI());
            ...
            logger.error("originalpath {} requestURI {} ", originalpath , requesturl);

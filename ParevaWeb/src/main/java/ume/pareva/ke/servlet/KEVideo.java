...
public class KEVideo extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LogManager.getLogger( KEVideo.class.getName());
    ...
    public void renderTemplateWithPagination(int index,HashMap videoParameterMap,List<Map<String,String>> videos,
    	...
    	try{
    		...
    		keEngine.getTemplate("index").evaluate(writer, context);
    	}catch(Exception e){

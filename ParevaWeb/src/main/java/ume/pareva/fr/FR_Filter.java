...
@Component("FR_Filter")
public class FR_Filter implements RegionFilter{
    static final Logger logger = LogManager.getLogger( FR_Filter.class.getName());
...
//        
    ...
    public boolean doFilterForRegion(HttpServletRequest  req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try{
            ...
            logger.info("---FR FILTER CALLED ---- {}",domain.getDefaultUrl());
            MobileClub club = UmeTempCmsCache.mobileClubMap.get(domain.getUnique());
            
            logger.info("---FR FILTER CALLED ---- {} Club {}",domain.getDefaultUrl(),club.getName());
...
//System.out.println("INSIDE forwardRequest : value of defaultServlet "+defaultServlet +" path: "+path+" service type: "+service.getServiceType());
        	...
        	if(req!=null){
        		System.out.println("FR_FILTER.forwardRequest exception req.getServerName(): " + req.getServerName());
        		System.out.println("FR_FILTER.forwardRequest exception domain: " + domain);
        		System.out.println("FR_FILTER.forwardRequest exception service: " + service);        		
        		System.out.println("FR_FILTER.forwardRequest exception user: " + user);        		
        		System.out.println("FR_FILTER.forwardRequest exception lang: " + lang);        		
        		System.out.println("FR_FILTER.forwardRequest exception serviceType: " + serviceType); 
        		System.out.println("FR_FILTER.forwardRequest exception path: " + path); 
        	}
        	
        	System.out.println("FR_Filter UmeCore.forwardRequest exception : " + e.getMessage());
                //e.printStackTrace();
    ...
    public void evaluateIPAddress(HttpServletRequest req){
        ...
        logger.info("---IP ADDRESS IN FR FILTER  ---- {}",ipAddress);

...
public class IPN_bak extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LogManager.getLogger( IPN_bak.class.getName());
	...
	public void processRequest(HttpServletRequest request, HttpServletResponse response){
		...
		String clubUnique=userSession.getClubUnique();
		String subscriptionId=ipnMap.get("subscription_id");
		if(clubUnique.equals(""))
		...
		if(event.equals("Subscription")){
			...
			if(!campaignId.equals("") && subscriptionResponse.equals("SUBSCRIPTION RECORD CREATED SUCCESSFULLY")){
			...
			UmeClubDetails umeClubDetails=UmeTempCmsCache.umeClubDetailsMap.get(clubUnique);

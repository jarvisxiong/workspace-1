...
public class POIPN extends HttpServlet {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = LogManager.getLogger(POIPN.class.getName());
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        String sqlstr = "insert into polandNotification (aUnique,aErrorCode,aEvent,aPurchaseId,aSubscriptionId,aSessionId,aAliase,aOpeId,aTransactionId,aCreated) values("
        ...
        if (event.equals("Subscription")) {
            ...
            insertBillingTryForUser(clubUser, club, transactionId);
            //	cpaLog(ipnMap,clubUser,club);
    ...
    public void insertBillingTryForUser(SdcMobileClubUser clubUser, MobileClub club, String transactionId) {
        MobileClubBillingTry mobileClubBillingTry = new MobileClubBillingTry();
        mobileClubBillingTry.setTransactionId(transactionId);
        mobileClubBillingTry.setResponseCode("00");

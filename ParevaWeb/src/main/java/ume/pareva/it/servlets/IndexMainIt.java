...
public class IndexMainIt extends HttpServlet {
    ...
    protected void processIndexMain(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //System.out.println("ItalyVIDEO REQUEST SESSION ATTRIBUTE VALUES in INDEXMAIN.JAVA FOR IT  " + aReq.toString());
        ...
        //System.out.println("ItalyVIDEO index main domain " + domainName);
        ...
        //System.out.println("ItalyVIDEO index main PART 3 line no. 95 " + domainName);
        ...
        try {
            ...
            //System.out.println("ItalyVIDEO index main PART 4 line no. 104 " + domainName);
        } catch (Exception e) {
        }
        ...
        //System.out.println("ItalyVIDEO INDEX MAIN AFTER READING ITEM UNQ AND TYPE================");
...
//            System.out.println("Sending redirect: http://" + domainName + "/" + target + "?unq=" + unq);
            ...
            if (!itype.equals("")) {
                try {
                    ...
                    System.out.println("IndexMainIt Exception line no. 212 " + e);
                }
                return;
            }
        ...
        //System.out.println("ItalyVIDEO READING THE CLIENT SERVICES NOW WITH DPMAIN+SSUBPAGE  " + domain + "  " + subpage);
        String[] props = null;
...
//                System.out.println("ItalyVIDEO Services " + j + " = " + servicesList[j]);
//            }
                //String sqlstr = "";
                String srvc = servicesList[1];
                String fName = servicesList[3];
                //System.out.println("ItalyVIDEO fname in IndexMAIN "+fName);

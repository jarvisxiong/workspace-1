 ...
 */
@Component("IT_Filter")
public class IT_Filter implements RegionFilter {
    ...
    public boolean doFilterForRegion(HttpServletRequest req,
		...
		// TODO IT Filteration here.
        // System.out.println("---IT FILTER CALLED ---- ");
        ...
        try {
            ...
            // System.out.println("---IT FILTER CALLED ---- "+domain.getDefaultUrl());
            MobileClub club = UmeTempCmsCache.mobileClubMap.get(domain.getUnique());
            // System.out.println("---IT FILTER CALLED ---- "+domain.getDefaultUrl()+" Club "+club.getName());
			...
			//System.out.println("IT FILTER PATH RECEIVED IS " + path);
...
//					 +" path: "+path+" service type: "+service.getServiceType());
            ...
            if (req != null) {
                System.out.println("IT_FILTER.forwardRequest exception req.getServerName(): " + req.getServerName());
                System.out.println("IT_FILTER.forwardRequest exception domain: " + domain);
                System.out.println("IT_FILTER.forwardRequest exception service: " + service);
                System.out.println("IT_FILTER.forwardRequest exception user: " + user);
                System.out.println("IT_FILTER.forwardRequest exception lang: " + lang);
                System.out.println("IT_FILTER.forwardRequest exception serviceType: " + serviceType);
                System.out.println("IT_FILTER.forwardRequest exception path: " + path);
            }

            System.out.println("IT_Filter UmeCore.forwardRequest exception : " + e);
            e.printStackTrace();

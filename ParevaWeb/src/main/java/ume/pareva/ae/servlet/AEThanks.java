...
@WebServlet("/AEThanks")
public class AEThanks extends HttpServlet {

    private static final long serialVersionUID = 1L;
    private static final Logger logger = LogManager.getLogger(AEThanks.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            frEngine.getTemplate("thanks").evaluate(writer, context);
        } catch (Exception e) {

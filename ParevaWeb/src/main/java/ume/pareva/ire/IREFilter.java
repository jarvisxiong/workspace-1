...
@Component("IE"+UmeFilter.SUFFIX)
public class IREFilter implements RegionFilter {
    static final Logger logger = LogManager.getLogger(IREFilter.class.getName());
    ...
    public boolean doFilterForRegion(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ThreadContext.put("REGION", "IE");
        ThreadContext.put("ROUTINGKEY", "IE-FILTER");
...
//System.out.println("INSIDE forwardRequest : value of defaultServlet "+defaultServlet +" path: "+path+" service type: "+service.getServiceType());
        	...
        	if(req!=null){
        		System.out.println("IRE_Filter.forwardRequest exception req.getServerName(): " + req.getServerName());
        		System.out.println("IRE_Filter.forwardRequest exception domain: " + domain);
        		System.out.println("IRE_Filter.forwardRequest exception service: " + service);
        		System.out.println("IRE_Filter.forwardRequest exception lang: " + lang);        		
        		System.out.println("IRE_Filter.forwardRequest exception serviceType: " + serviceType); 
        		System.out.println("IRE_Filter.forwardRequest exception path: " + path); 
        	}
        	
        	System.out.println("IRE_Filter UmeCore.forwardRequest exception : " + e);
                e.printStackTrace();
